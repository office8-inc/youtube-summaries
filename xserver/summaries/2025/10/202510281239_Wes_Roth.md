...
- **タイトル**: Self Improving AI is getting wild
- **チャンネル**: Wes Roth
- **動画URL**: [https://www.youtube.com/watch?v=TCDpDXjpgPI](https://www.youtube.com/watch?v=TCDpDXjpgPI)
- **動画ID**: TCDpDXjpgPI
- **公開日**: 2025年10月28日 12:39
- **再生回数**: 0 回
- **高評価数**: 0

## 💡 概要

この動画では、AIが自らを改善する「再帰的自己改善」の最新研究について解説しています。Jürgen Schmidhuber氏らによるHuxley Gödel Machineの論文を中心に、従来のSakana AIのDarwin Gödel Machineとの比較、そしてClade Meta Productivity（CMP）という新しい指標の重要性を詳しく説明しています。AI研究者や機械学習に興味がある方、そして進化的アルゴリズムやメタ学習の最前線を知りたい技術者に向けた、深い洞察に満ちた内容です。SWE-benchなどの実際のベンチマークでの成果も紹介されています。

## ⭐ 重要なポイント

- **再帰的自己改善の現実化**: AIエージェントが自分自身のコードを書き換えて性能を向上させる技術が実用段階に到達
- **Clade Meta Productivity（CMP）**: 短期的なベンチマーク性能ではなく、子孫の潜在的な改善可能性を評価する新しい指標を導入
- **系統樹アプローチ**: 生物の進化に似た「枝分かれ」的な探索により、短期的には劣っても長期的に優れた解を発見
- **実証的な成果**: Huxley Gödel MachineはSWE-bench Lightで人間レベルの性能を達成し、従来のDarwin Gödel Machineより効率的
- **汎化性能**: 異なるコーディングタスクや言語モデルへの転移学習でも高い性能を示し、実用性を証明
