# 📺 ニューヨーク・タイムズはいかにしてペイウォール突破者を完全に封じ込めたか
...
この動画は、インターネット上で続く「ペイウォール vs ハッカー」の戦いを歴史的な流れとともに解説しています。1990年代のクッキーベースのシンプルな仕組みから、JavaScriptの無効化による回避、そしてニューヨーク・タイムズが導入した機械学習を活用した「ダイナミックメーター」まで、ペイウォール技術の進化を詳しく紹介します。特にニューヨーク・タイムズが開発したSラーナーモデルを中心に、AIを使って各ユーザーに最適な無料記事数を予測する仕組みを分かりやすく説明します。技術に興味があるエンジニアやウェブ開発者に向けた内容で、ビジネスモデルとテクノロジーの交差点に光を当てています。

## ⭐ 重要なポイント

- **ペイウォールの歴史**: 1996年のMicrosoftのオンライン誌Slateが先駆けとなり、1998年にはウォール・ストリート・ジャーナルが有料購読モデルで20万人以上のオンライン読者を獲得した
- **ソフトペイウォールの革新**: 2007年にフィナンシャル・タイムズが導入した「月30本まで無料」のソフトペイウォールがゲームチェンジャーとなり、2011年にニューヨーク・タイムズが採用して3ヶ月で22万4千人の購読者を獲得した
- **AIによる最適化**: ニューヨーク・タイムズは機械学習の「Sラーナー」を使い、ユーザーの閲覧履歴や訪問頻度から各読者に最適な無料記事数を予測している
- **因果推論の課題**: 「1人のユーザーが5本無料と10本無料の両方を体験することはできない」というカusal inferenceの根本的な問題をバックテストで解決している
- **ペイウォール回避の手法**: クッキー削除・複数メールアドレス・URLパラメーター操作・JavaScript無効化・Googleキャッシュ閲覧など、長年にわたって様々な回避手法が存在してきた
