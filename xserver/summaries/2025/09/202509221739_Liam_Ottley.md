# 📺 AIツールを売るな！稼げる3つのAIエージェントで年収1,000万円を狙え
...
本動画は、AI代理店起業家のリアム・オットリーが、年収10万ドル（約1,500万円）を目指すAIビジネス構築の具体的ロードマップを解説する内容です。ゲストのエドウィンが実際に販売している「CXエージェント」「レベニューリカバリーエージェント」「コマースエージェント」の3種類のAIエージェントを詳しく紹介します。各エージェントが解決するビジネス課題と具体的な受注価格帯（5,000〜30,000ドル）も公開されており、AIビジネスを始めたい起業家や副業志望者に最適なコンテンツです。汎用チャットボットではなく「ビジネスの痛点を直接解決するAIエージェント」を売ることが成功の鍵だと強調しています。

## ⭐ 重要なポイント

- **3つのAIエージェントが柱**：CXエージェント（顧客体験）・レベニューリカバリーエージェント（失注回復）・コマースエージェント（購買誘導）の3種が高単価受注の核心
- **価格帯は5,000〜30,000ドル**：CXエージェントは7,000〜20,000ドル、レベニューリカバリーは約10,000ドル、コマースエージェントは5,000〜30,000ドルで販売可能
- **「カスタマーサポート」ではなく「カスタマーエクスペリエンス」**：受動的な問い合わせ対応でなく、能動的に顧客をケアし購買を促進するエージェントが企業に真の価値をもたらす
- **パーソナライゼーションが差別化のカギ**：過去の顧客履歴・好み・ペットの名前まで記憶し個別対応することで、プレミアムブランド体験を実現できる
- **市場調査でも顧客体験AIは上位**：生成AIが企業にもたらすインパクト調査で、顧客体験は生産性に次ぐ第2位——いまがAIエージェントビジネスを始める絶好のタイミング
