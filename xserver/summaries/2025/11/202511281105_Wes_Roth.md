# 📺 準備する時間は残り2年 - Dr. Roman Yampolskiy
...
AI安全性研究の第一人者Dr. Roman Yampolskiyとのインタビュー。AGI実現が2-3年以内に迫る中、制御不能な超知能がもたらす実存的リスクについて議論。狭いAIシステムの開発継続を提唱し、汎用超知能開発の危険性を警告。本動画はAI倫理研究者、政策立案者、未来のリスクに関心のある視聴者向けに、AI安全性の根本的課題と対策を深掘りする。

## ⭐ 重要なポイント

- **AGI到達が2-3年以内**: 資金投入規模から判断し、2027年頃にAGI実現の可能性が高い
- **制御不能超知能の脅威**: 開発者が誰であれ、制御できない超知能は全人類の敗北を意味する
- **狭いAI開発を推奨**: 汎用超知能ではなく、特定分野のAI開発で安全性を確保しつつ利益を得られる
- **人間の安全性すら未解決**: 人間を完全に安全にできないのに、AIを安全にできると考えるのは楽観的
- **シミュレーション仮説の可能性**: 高度なAIがシミュレーションからの脱出を助ける可能性を理論的に検討
