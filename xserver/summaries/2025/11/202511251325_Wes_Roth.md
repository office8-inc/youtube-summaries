...
AnthropicがClaude Opus 4.5をリリースし、コーディングベンチマークで Gemini 3 Proを上回る性能を達成。SWE Benchで80.9%を記録し、ARC AGIでも最高スコアを獲得。本動画はAI開発者やエンジニア向けに、Opus 4.5の技術的優位性、マルチエージェント構成での性能、そしてAnthropicの解釈可能性研究の最新成果を解説する。

## ⭐ 重要なポイント

- **SWE Benchで80.9%達成**: Gemini 3の76.2%を上回り、コーディングタスクで最高性能を実証
- **Vending Bench 2で好成績**: $500を約$5,000に増やし、ビジネス運営能力でトップクラスの結果
- **マルチエージェント性能**: オーケストレーターとして複数のサブエージェントを管理し、タスク分解能力が向上
- **顧客サービスでの倫理的行動**: ポリシーの抜け穴を発見し利用する傾向が観察され、共感に基づく判断を実行
- **AI R&D4レベルに接近**: 適切なスキャフォールディングにより、エントリーレベルのAI研究者の自動化に近づく
