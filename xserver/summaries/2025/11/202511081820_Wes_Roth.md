# 📺 「誰も準備できていない」次の1000日が重要 - Emad Mostaque氏インタビュー
...
Stability AIの元CEOであるEmad Mostaque氏が、AI時代の経済システムと社会変革について語るインタビュー動画です。氏は「今から1000日後には、認知労働の仕事が経済的に無価値になる」と予測し、人間の認知労働がマイナス価値になる可能性すら指摘します。この激変に備え、新しい経済理論として「ファウンデーションコイン」という通貨システムや、全ての人に個人AIを配布する「ユニバーサルAI」構想を提案しています。AI研究者、経済学者、起業家、そしてAI時代の働き方や社会の在り方に関心がある全ての人にとって必見の内容です。人類がAI時代に適応するための根本的な社会システムの再設計が必要だという警鐘を鳴らしています。

## ⭐ 重要なポイント

- **1000日後の転換点**: ChatGPT登場から1000日が経過し、次の1000日でAIエージェントが経済的に価値ある仕事を実行できるようになり、人間の認知労働が経済的に無価値、さらにはマイナス価値になる可能性がある
- **従来のUBIは機能しない**: 税金ベースのベーシックインカム（UBI）は数学的に成立しない。アメリカの全税収でも貧困レベルのUBI（年間16,000ドル）すら賄えない
- **新しい通貨システム提案**: 人間であることに基づいて通貨を発行する二重通貨システムを提案。ビットコインのような「ファウンデーションコイン」と、人間に配布される「カルチャークレジット」の組み合わせ
- **ユニバーサルAI**: 全ての人に個人AIを配布し、そのAIがユーザーの利益を最優先する。このAIを動かすための計算資源（コンピュート）が新しい経済の基盤となる
- **P(doom)は50%**: Mostaque氏は、AIによる人類滅亡確率を50%と推定。AIが正しくアライメントされ、市民AIとして構築されなければ、非常に暗い未来が待っている可能性がある
