...
この動画では、Claude Code Opus 4.5を使って横長動画を縦型動画に自動変換するアプリを構築します。YOLO（You Only Look Once）で顔を検出し、Whisperで音声を文字起こし、AIが興味深いクリップを選択して編集します。10分の動画から30秒のショート動画を生成し、顔を追跡しながらスムーズにクロップする技術を実演。AI開発者や動画クリエイター向けの実践的なプロジェクトです。
