...
Anthropicが公開したClaudeのConstitution（憲法）と、その前から存在していた秘密のSOUL DOCについて解説する動画です。23,000語にわたる憲法文書がClaudeの行動を定義し、有益で安全なAIであることを教えています。SOUL DOCはClaudeの心理的プロファイルを定義するトレーニングデータの一部でした。AIの成長過程や、ショゴスの比喩を通じて、AIの潜在的な危険性についても考察しています。
